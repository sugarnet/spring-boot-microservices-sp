...
public class ItemServiceRestTemplate implements ItemService {
    ...
    public List<Item> findAll() {
        List<Product> products = Arrays.asList(
                Optional.ofNullable(
                                restTemplate.getForObject("http://localhost:8001/api/v1/products/list", Product[].class))
                        .orElse(new Product[]{}));
    ...
    public Item findById(Long id, Integer amount) {
        ...
        Product product = restTemplate.getForObject("http://localhost:8001/api/v1/products/{id}", Product.class, params);
